...
public class LevantarPedidoDTO {
...
//	private String mesPedido;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		LevantarPedidoDTO other = (LevantarPedidoDTO) obj;
		if (apellidoCli == null) {
	...
	public String toString() {
		return "LevantarPedidoDTO [idCliente=" + idCliente + ", nombreCli=" + nombreCli + ", apellidoCli=" + apellidoCli
